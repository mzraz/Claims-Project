  ...
  return (
    <>
      ...
      >
        ...
        <BreadcrumbNext title="Firm Management" items={BCrumb} navigationURL={'/admin/recovery'} />
      </Box>
                ...
                <Stack direction="row" spacing={3}>
                  <Box sx={{ width: '100%' }}>
                    <CustomFormLabel htmlFor="name">
                      Is the claimant claiming damage to their own vehicle?
                  ...
                  <Box sx={{ width: '100%' }}>
                    <CustomFormLabel htmlFor="type">
                      Is the claim for vehicle damage proceeding through claimant's insurer?
                      <span style={{ color: 'red', fontSize: '15px' }}>*</span>
                    </CustomFormLabel>
                    <CustomTextField
                      id="type"
                  ...
                  <Box sx={{ width: '100%' }}>
                    <CustomFormLabel htmlFor="url">
                      If No, is the claim for the vehicle damage proceeding through an alternative
                      company?
                      <span style={{ color: 'red', fontSize: '15px' }}>*</span>
                    </CustomFormLabel>
                    <CustomTextField
                ...
                <Stack direction="row" spacing={3}>
                  <Box sx={{ width: '100%' }}>
                    <CustomFormLabel htmlFor="countryId">
                      If the claim is proceeding through an alternative company. Please provide full
                      details, if known
                      <span style={{ color: 'red', fontSize: '15px' }}>*</span>
                    </CustomFormLabel>
                    <CountrySelect
                  ...
                  <Box sx={{ width: '100%', opacity: !formik.values.countryId ? '.5' : null }}>
                    <CustomFormLabel htmlFor="city">
                      Is the vehicle a total loss or likely to be?
                      <span style={{ color: 'red', fontSize: '15px' }}>*</span>
                    </CustomFormLabel>
                    <CustomTextField
                      id="city"
                  ...
                  <Box sx={{ width: '100%', opacity: !formik.values.countryId ? '.5' : null }}>
                    <CustomFormLabel htmlFor="contactNo">
                      Do you require the defendant's insurer to organise the repairs and/or
